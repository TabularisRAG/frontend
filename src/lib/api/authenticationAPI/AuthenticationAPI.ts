import type { LoginUser, RegistrationUser, User } from "$lib/entities/user";
import APIClient from "../ApiClient";

export default class AuthenticationAPI extends APIClient {

    public async login(user: LoginUser): Promise<string> {
    ...
    public async registerUser(newUser: RegistrationUser): Promise<void> {
        try {
