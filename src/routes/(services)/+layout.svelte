...
<div class="sticky top-0">
  <nav class="flex justify-between items-center mx-8 py-2 gap-8">
    <Button href="../" variant="link" class="text-2xl font-bold">TabularisRAG</Button>
        ...
        <DropdownMenu.Group>
          <DropdownMenu.Sub>
            ...
            <DropdownMenu.SubContent sideOffset={8}>
              <DropdownMenu.Item onSelect={()=> setMode("dark")}>
                <Moon class="mr-1 text-foreground"/>{m.dark()}</DropdownMenu.Item>
              <DropdownMenu.Item onSelect={()=> setMode("light")}>
                <Sun class="mr-1 text-foreground"/>{m.light()}</DropdownMenu.Item>
              <DropdownMenu.Item onSelect={()=> resetMode()}>
                <MonitorSmartphone class="mr-1 text-foreground"/>{m.system()}</DropdownMenu.Item>
